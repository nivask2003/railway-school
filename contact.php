...
<body>
    <?=template_header()?>
    <section class="contact-page-banner py-5">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4 col-lg-4">
                    <div class="icon-box" data-aos="fade-up" data-aos-delay=100>
                        <div class="icon-circle">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#c89b3c"><path d="M160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h640q33 0 56.5 23.5T880-720v480q0 33-23.5 56.5T800-160H160Zm320-280 320-200v-80L480-520 160-720v80l320 200Z"/></svg>
                        </div>
                        <h3 class="box-title">Email</h3>
                            <p class="box-desc"><a href="mailto:rmhssmdu@gmail.com">rmhssmdu@gmail.com</a></p>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-4" data-aos="fade-left" data-aos-delay=150>
                    <div class="icon-box">
                        <div class="icon-circle">
                          <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#c89b3c"><path d="M798-120q-125 0-247-54.5T329-329Q229-429 174.5-551T120-798q0-18 12-30t30-12h162q14 0 25 9.5t13 22.5l26 140q2 16-1 27t-11 19l-97 98q20 37 47.5 71.5T387-386q31 31 65 57.5t72 48.5l94-94q9-9 23.5-13.5T670-390l138 28q14 4 23 14.5t9 23.5v162q0 18-12 30t-30 12Z"/></svg>  
                        </div>
                        <h3 class="box-title">Phone Number</h3>
                            <p class="box-desc"><a href="mailto:04522900174">0452 - 2900174</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="contact-2">
        <div class="container">
            ...
            <h2 class="section-title">Let's Connect and Grow Together</h2>
            <div class="row">
